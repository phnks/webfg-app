...
const mockRenderAttribute = jest.fn((name, attr, displayName) => /*#__PURE__*/React.createElement("div", {
  key: name,
  className: "attribute-item"
}, /*#__PURE__*/React.createElement("label", null, displayName), /*#__PURE__*/React.createElement("input", {
  type: "number",
  value: attr?.attribute?.attributeValue || 0,
  readOnly: true
})));
describe('AttributeGroups Component', () => {
  ...
  test('renders without crashing', () => {
    render(/*#__PURE__*/React.createElement(AttributeGroups, {
