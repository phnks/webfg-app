...
const createActionMocks = [mockListActions, {
  request: {
    query: CREATE_ACTION,
    variables: {
      input: {
...
describe('ActionForm Component', () => {
  test('renders without crashing', () => {
    render(/*#__PURE__*/React.createElement(ActionFormWrapper, null, /*#__PURE__*/React.createElement(ActionForm, null)));
  });
  ...
  test('displays form title for editing existing action', () => {
    ...
    render(/*#__PURE__*/React.createElement(ActionFormWrapper, null, /*#__PURE__*/React.createElement(ActionForm, {
  ...
  test('updates target attribute field value', () => {
    ...
    fireEvent.change(targetAttributeSelect, {
      target: {
        value: 'AGILITY'
      }
    });
  ...
  test('handles form submission errors', async () => {
    const errorMocks = [mockListActions, {
      request: {
        query: CREATE_ACTION,
        variables: {
          input: {
    ...
    render(/*#__PURE__*/React.createElement(ActionFormWrapper, {
      apolloMocks: errorMocks
    }, /*#__PURE__*/React.createElement(ActionForm, null)));
    const nameInput = screen.getByLabelText('Name');
    const sourceAttributeSelect = screen.getByLabelText('Source Attribute');
    const targetAttributeSelect = screen.getByLabelText('Target Attribute');
    const submitButton = screen.getByRole('button', {
