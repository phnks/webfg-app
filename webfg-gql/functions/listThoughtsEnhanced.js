...
exports.handler = async (event) => {
    ...
    if (filter) {
        ...
        if (filter.search) {
            // Search in name, nameLowerCase, description, and descriptionLowerCase
            filterExpressions.push('(contains(#name, :search) OR (attribute_exists(#nameLowerCase) AND contains(#nameLowerCase, :searchLower)) OR (attribute_exists(#description) AND contains(#description, :search)) OR (attribute_exists(#descriptionLowerCase) AND contains(#descriptionLowerCase, :searchLower)))');
...
function getNestedValue(obj, path) {
    // Handle nested paths like "attributeValue"
