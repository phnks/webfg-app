...
exports.handler = async (event) => {
    ...
    if (filter) {
        ...
        if (filter.objectCategory) {
            filterExpressions.push('#objectCategory = :objectCategory');
            expressionAttributeNames['#objectCategory'] = 'objectCategory';
            expressionAttributeValues[':objectCategory'] = filter.objectCategory;
        }
...
// Helper functions (reused from listCharactersEnhanced.js)
...
function addAttributeFilter(attributeFilter, fieldName, filterExpressions, expressionAttributeNames, expressionAttributeValues) {
    ...
    if (attributeFilter.isGrouped !== undefined) {
        filterExpressions.push(`${attributeName}.#isGrouped = :${fieldName}_isGrouped`);
        expressionAttributeNames[attributeName] = fieldName;
    ...
    if (attributeFilter.attributeValue) {
        const valuePath = `${attributeName}.#attributeValue`;
        expressionAttributeNames[attributeName] = fieldName;
