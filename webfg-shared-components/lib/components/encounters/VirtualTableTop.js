...
const VirtualTableTop = ({
      ...
      switch (element.type) {
        case 'LINE':
          if (element.coordinates.length >= 2) {
            ctx.beginPath();
            ctx.moveTo(element.coordinates[0].x * CELL_SIZE + CELL_SIZE / 2, element.coordinates[0].y * CELL_SIZE + CELL_SIZE / 2);
            for (let i = 1; i < element.coordinates.length; i++) {
              ctx.lineTo(element.coordinates[i].x * CELL_SIZE + CELL_SIZE / 2, element.coordinates[i].y * CELL_SIZE + CELL_SIZE / 2);
            }
            ctx.stroke();
          }
          break;
    ...
    const touchMoveHandler = e => {
      if (draggingItem) {
        ...
        const {
          x,
          y
        } = getGridCoordinates(e); // Use updated function
        setHoveredCell({
          x,
          y
        });
  ...
  const handleContextMenu = e => {
    ...
    if (clickedItem && (clickedItem.type === 'object' || clickedItem.type === 'terrain')) {
      setContextMenu({
        x: e.clientX,
        // Position menu based on screen coords
        y: e.clientY,
  ...
  const findItemAt = (canvasX, canvasY) => {
    ...
    for (const terr of terrain) {
      switch (terr.type) {
        case 'VERTICAL_LINE':
          if (gridX === terr.startX && gridY >= terr.startY && gridY <= terr.startY + terr.length) {
            return {
              type: 'terrain',
              id: terr.terrainId,
              item: terr
        ...
        case 'HORIZONTAL_LINE':
          if (gridY === terr.startY && gridX >= terr.startX && gridX <= terr.startX + terr.length) {
            return {
              type: 'terrain',
              id: terr.terrainId,
              item: terr
        ...
        case 'DIAGONAL_LINE':
          ...
          if (dx >= 0 && dx <= terr.length && dy >= 0 && dy <= terr.length && Math.abs(dx - dy) <= 1) {
            return {
              type: 'terrain',
              id: terr.terrainId,
              item: terr
  ...
  function drawTerrainElement(ctx, terrainElement) {
    ...
    switch (type) {
      case 'VERTICAL_LINE':
        ...
        ctx.lineTo(startX * CELL_SIZE, (startY + length) * CELL_SIZE);
        break;
      case 'HORIZONTAL_LINE':
        ctx.moveTo(startX * CELL_SIZE, startY * CELL_SIZE);
        ctx.lineTo((startX + length) * CELL_SIZE, startY * CELL_SIZE);
        break;
      case 'DIAGONAL_LINE':
        ctx.moveTo(startX * CELL_SIZE, startY * CELL_SIZE);
        ctx.lineTo((startX + length) * CELL_SIZE, (startY + length) * CELL_SIZE);
        break;
    }
    ctx.stroke();
  }
  function drawCharacter(ctx, character) {
    ...
    ctx.beginPath();
    ctx.arc(x * CELL_SIZE + CELL_SIZE / 2, y * CELL_SIZE + CELL_SIZE / 2, CELL_SIZE / 2 - 4, 0, Math.PI * 2);
    ctx.fill();
    ctx.fillStyle = 'white';
    ctx.font = '14px Arial';
    ctx.textAlign = 'center';
    ctx.textBaseline = 'middle';
    ctx.fillText(name.charAt(0), x * CELL_SIZE + CELL_SIZE / 2, y * CELL_SIZE + CELL_SIZE / 2);
  }
  function drawObject(ctx, obj) {
    ...
    ctx.textAlign = 'center';
    ctx.textBaseline = 'middle';
    ctx.fillText(name.charAt(0).toUpperCase(), x * CELL_SIZE + CELL_SIZE / 2, y * CELL_SIZE + CELL_SIZE / 2);
  }
  return /*#__PURE__*/React.createElement("div", {
    className: "virtual-tabletop"
  }, /*#__PURE__*/React.createElement("div", {
    className: "grid-controls"
  }, /*#__PURE__*/React.createElement("div", {
    className: "grid-size-control"
  }, /*#__PURE__*/React.createElement("label", null, "Height:"), /*#__PURE__*/React.createElement("button", {
    onClick: () => onUpdateGridSize(gridRows - 1, gridColumns),
    disabled: gridRows <= 10
  }, "-"), /*#__PURE__*/React.createElement("span", null, gridRows * 5, "'"), /*#__PURE__*/React.createElement("button", {
    onClick: () => onUpdateGridSize(gridRows + 1, gridColumns)
  }, "+")), /*#__PURE__*/React.createElement("div", {
    className: "grid-size-control"
  }, /*#__PURE__*/React.createElement("label", null, "Width:"), /*#__PURE__*/React.createElement("button", {
    onClick: () => onUpdateGridSize(gridRows, gridColumns - 1),
    disabled: gridColumns <= 10
  }, "-"), /*#__PURE__*/React.createElement("span", null, gridColumns * 5, "'"), /*#__PURE__*/React.createElement("button", {
    onClick: () => onUpdateGridSize(gridRows, gridColumns + 1)
  }, "+"))), /*#__PURE__*/React.createElement("div", {
  ...
  })), /*#__PURE__*/React.createElement(CharacterSummary, {
  ...
  }, /*#__PURE__*/React.createElement(FaTrash, null), " Delete ", contextMenu.itemType)));
};
