...
import { CREATE_CHARACTER, UPDATE_CHARACTER, LIST_CHARACTERS } from "../../graphql/operations";
import "./Form.css";
...
const CHARACTER_CATEGORIES = ['HUMAN', 'TREPIDITE', 'MONSTER', 'CARVED', 'ANTHRO', 'ICER', 'DAXMC', 'QRTIS', 'TYVIR'];
const CHARACTER_RACES = ['HUMAN', 'ANTHRO', 'CARVED', 'TREPIDITE', 'DHYARMA'];
...
const CharacterForm = ({
  ...
  const renderAttributeForForm = (attributeName, attribute, displayName) => {
    ...
    }), "Group")), validationError && /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: '0.8em',
        color: '#dc3545',
        marginTop: '2px'
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, /*#__PURE__*/React.createElement("h2", null, isEditing ? "Edit Character" : "Create New Character"), /*#__PURE__*/React.createElement("div", {
    className: "attribute-total-display"
  }, /*#__PURE__*/React.createElement("span", {
    className: `current-total ${currentTotal < targetTotal ? 'insufficient' : currentTotal > targetTotal ? 'excessive' : 'valid'}`
  }, "Total: ", currentTotal), /*#__PURE__*/React.createElement("span", {
    className: "total-separator"
  }, "/"), /*#__PURE__*/React.createElement("div", {
    className: "target-total-input"
  }, /*#__PURE__*/React.createElement("label", null, "Target:"), /*#__PURE__*/React.createElement(MobileNumberInput, {
    ...
    className: "target-help-text"
  }, "Default: 10 \xD7 ", getAllAttributeNames().length, " = ", calculateDefaultTargetTotal())))), validationError && /*#__PURE__*/React.createElement("div", {
    className: "validation-error"
  }, validationError), /*#__PURE__*/React.createElement("div", {
    className: "form-section"
  }, /*#__PURE__*/React.createElement("h3", null, "Basic Information"), /*#__PURE__*/React.createElement("div", {
    className: "form-grid"
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, CHARACTER_CATEGORIES.map(cat => /*#__PURE__*/React.createElement("option", {
    key: cat,
    value: cat
  }, cat)))), /*#__PURE__*/React.createElement("div", {
    className: "form-group"
  }, /*#__PURE__*/React.createElement("label", null, "Race"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      alignItems: 'center',
      gap: '10px'
  ...
  }, CHARACTER_RACES.map(race => /*#__PURE__*/React.createElement("option", {
    key: race,
    value: race
  }, race))), /*#__PURE__*/React.createElement("label", {
    className: "checkbox-label",
    style: {
      margin: 0,
      fontSize: '0.9em'
  ...
  }), "Override race restrictions"))), /*#__PURE__*/React.createElement("div", {
    className: "form-group"
  }, /*#__PURE__*/React.createElement("label", null, "Will"), /*#__PURE__*/React.createElement(MobileNumberInput, {
    value: formData.will,
  ...
  }, /*#__PURE__*/React.createElement("label", null, "Description"), /*#__PURE__*/React.createElement("button", {
    type: "button",
  ...
  }, "Generate Description")), /*#__PURE__*/React.createElement("div", {
    ...
    className: "form-section"
  }, /*#__PURE__*/React.createElement("h3", null, "Special Abilities"), /*#__PURE__*/React.createElement("div", {
    className: "form-group"
  }, formData.special.length === 0 && /*#__PURE__*/React.createElement("p", {
    className: "empty-message"
  }, "No special abilities added."), /*#__PURE__*/React.createElement("ul", {
    className: "parts-list"
  }, formData.special.map((ability, index) => /*#__PURE__*/React.createElement("li", {
    key: index
  }, ability, /*#__PURE__*/React.createElement("button", {
    type: "button",
    onClick: () => handleSpecialRemove(index),
    className: "button-remove"
  }, "Remove")))), /*#__PURE__*/React.createElement("div", {
    className: "special-input-group"
  }, /*#__PURE__*/React.createElement("input", {
    type: "text",
  ...
  }, "Add Ability")))), /*#__PURE__*/React.createElement("div", {
    ...
    title: isSubmitDisabled ? (currentTotal !== targetTotal ? `Attribute total must equal ${targetTotal}` : '') + (hasRaceViolations ? (currentTotal !== targetTotal ? ' and ' : '') + 'Race restrictions must be satisfied' : '') : ''
  }, isEditing ? "Update Character" : "Create Character"))), /*#__PURE__*/React.createElement(ErrorPopup, {
    error: error,
