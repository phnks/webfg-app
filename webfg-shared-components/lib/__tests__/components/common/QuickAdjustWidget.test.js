...
describe('QuickAdjustWidget Component', () => {
  ...
  test('renders without crashing', () => {
    render(/*#__PURE__*/React.createElement(QuickAdjustWidget, defaultProps));
  });
  ...
  test('respects minimum value constraint', async () => {
    ...
    mockOnAdjust.mockResolvedValue();
    render(/*#__PURE__*/React.createElement(QuickAdjustWidget, props));
    const input = screen.getByDisplayValue('1');
    fireEvent.change(input, {
      target: {
        value: '2'
  ...
  test('handles default props correctly', () => {
    ...
    render(/*#__PURE__*/React.createElement(QuickAdjustWidget, minimalProps));
